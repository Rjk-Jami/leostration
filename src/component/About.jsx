    ...
    return (
        <div id="" className=" xl:h-screen flex flex-col items-center xl:items-start ">
              ...
              <div className="pt-[36px] xl:pt-[142px] ">
                ...
                <div className="pt-[36px] xl:pt-[85px] space-y-5  font-extralight xl:text-[14px] text-[12px]  xl:text-left text-center text-gray-300 px-[81px] xl:px-[0px]" >
                ...
                <p>Leon Sarker is the founder of Leostration, a <br className='xl:hidden block' ></br>graphic design and illustration studio based in <br className='block' ></br>Rajshahi, Bangladesh.</p>
                  ...
                  <p className=''>His work is characterized by the use of bold <br className='xl:hidden block' ></br>colors, geometric shapes, and typography, and it often reflects<br className='hidden xl:block'></br>the unique needs of <br className='xl:hidden block'></br>each client.</p>
                </div>
              </div>
            </div>
    );
