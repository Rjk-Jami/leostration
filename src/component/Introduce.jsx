...
const Introduce = () => {
    return (
        <div id="" className=" xl:h-screen ">
              ...
              <div className=" xl:mt-[140px] space-y-5">
                <p className="text-[10px]  xl:text-left text-center xl:text-[16px] xl:ms-1">Since 2019</p>
                ...
                <div className="hidden xl:flex gap-[160px] pt-4">
              ...
              <div className="xl:hidden">
                <p className=' text-[6px] mt-11 text-center'>© 2024 Leon S. All Rights Reserved</p>
              </div>
            </div>
    );
};
